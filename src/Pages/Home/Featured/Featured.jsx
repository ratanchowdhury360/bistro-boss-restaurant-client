...
const Featured = () => {
    return (
        <div className="fatured-item my-20 text-white " style={{ backgroundImage: `url(${featuredImg1})` }} >
            <SectionTitle subHeading={"Check it out"} heading={"Featured Item"}> </SectionTitle>

            <div className="md:flex gap-10 items-center text-white px-36 py-20 pb-20 pt-12"  >
                <div>
